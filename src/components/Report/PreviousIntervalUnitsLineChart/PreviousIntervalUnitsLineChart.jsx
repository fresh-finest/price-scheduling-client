...
const PreviousIntervalUnitsLineChart = ({ metrics, previousDateRange }) => {
  ...
  const chartData = filterByDateRange(allChartData, previousDateRange);

  return (
    <Card className=" px-1 py-2 mb-3">
      <ResponsiveContainer width="100%" height={130}>
        <LineChart data={chartData} margin={{ top: 10, right: 5, bottom: 0, left: 0 }}>
          <CartesianGrid horizontal vertical={false} stroke="#d3d3d3" strokeWidth={0.4} />
...
export default PreviousIntervalUnitsLineChart;
